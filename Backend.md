...
This repository includes a full, machine-friendly API reference with request/response schemas and possible error responses: see `api.md` in the repository root for complete details.
